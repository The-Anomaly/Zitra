...
const InvestmentFormDollar: React.FC<ApplyProps> = ({ show, closeModal }) => {
  ...
  const sendEmail = (data: InvestmentDollarData) => {
    setLoading(true);
    axios
      .post(
        "https://anomaly-mailer.netlify.app/.netlify/functions/server/mailjet",
        {
          messages: [
            ...
            <p style="font-size:14px">A new investment application request has been submitted for the product <b>Zitra Dollar Fund</b> on your website. The details are below:</p>
            ...
            <li>Investment Amount: <b>USD ${data.amount}</b></li>
            <li>Tenure: <b>360 days (locked-in)</b></li>
            </ul>
            Best regards.
          `,
